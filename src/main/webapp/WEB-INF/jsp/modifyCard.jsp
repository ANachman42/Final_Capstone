...
<c:url var="chosenCss" value="/css/chosen.css" />
<link rel="stylesheet" type="text/css" href="${chosenCss}">

<c:url var="chosenJs" value="/js/chosen.jquery.js" />
	...
	<div class="card body-card">
		...
		<form id="submitCard" method="POST" action="${submitCard}">
			...
			<div style="text-align: center">
				...
				<label class="card_label">Search Tags:</label> <select
					 id="tagText" name="tagId" multiple>
...
<script>
	...
	$('select#deckSelect').chosen({width: "45%"});
	
	$('select#tagText').chosen({width: "45%"}); 
